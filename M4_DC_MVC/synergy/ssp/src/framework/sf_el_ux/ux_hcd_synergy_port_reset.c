...
static ULONG ux_ms_to_ticks(ULONG time_ms);
...
UINT  ux_hcd_synergy_port_reset(UX_HCD_SYNERGY *hcd_synergy, ULONG port_index)
{
 ...
 /*******************************************************************************************************************//**
 * @brief: This function is used to calculate timer ticks for specific for specific time
 *
 * @param [in] time_ms   Time in milliseconds
 * @return timer ticks
  **********************************************************************************************************************/
 static inline ULONG ux_ms_to_ticks(ULONG time_ms)
 {
