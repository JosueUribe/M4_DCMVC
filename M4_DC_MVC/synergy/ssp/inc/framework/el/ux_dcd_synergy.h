...
{                                            
    ...
    ULONG           ux_dcd_synergy_pipe[UX_DCD_SYNERGY_MAX_PIPE+1];     /* "+1" is added to support total number of pipes
                                                                         * e.g.S1 series supports 0-7(total 8) pipes,
                                                                         * as "UX_DCD_SYNERGY_MAX_PIPE" is defined as 7   */
