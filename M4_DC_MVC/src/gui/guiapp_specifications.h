...
#define ID_EMBEDDED_SW 2
#define ID_SPEED_TEXT 3
#define ID_CMD_TEXT 4
#define ID_RPM 5
#define ID_HW_VERSION 6
#define ID_SW_VERSION 7
#define ID_CESEQ_C0010_CESEQ_P001 8
#define ID_M4_DC_MVC_1909 9
#define ID_APTIV_SIGNATURE 10
#define ID_SW_ENGINEERS 11
#define ID_GEMMA_CORONA 12
#define ID_JOSUE_URIBE 13
#define ID_VICTOR_ALVARADO 14
#define ID_DUTY_CYCLE 15
#define ID_WINDOWCHANGER_SYS 16
#define ID_SYS_DIAGNOSTICS 17
...
typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT main_screen_embedded_sw;
    GX_PROMPT main_screen_MotorSpeed;
    GX_PROMPT main_screen_SpeedCmd;
    GX_WINDOW main_screen_animation_window;
    GX_PROMPT main_screen_rpm;
    GX_PROMPT main_screen_hw_version;
    GX_PROMPT main_screen_sw_version;
    GX_PROMPT main_screen_ceseq_c001_ceseq_p001;
    GX_PROMPT main_screen_m4_dc_mvc_1909;
    GX_WINDOW main_screen_aptiv_signature;
    GX_PROMPT main_screen_sw_engineers;
    GX_PROMPT main_screen_gemma_corona;
    GX_PROMPT main_screen_josue_uribe;
    GX_PROMPT main_screen_victor_alvarado;
    GX_PROMPT main_screen_duty_cycle;
    GX_PROMPT main_screen_unit_percentage;
    GX_TEXT_BUTTON main_screen_windowchanger_sys;
} MAIN_SCREEN_CONTROL_BLOCK;

typedef struct SYSTEM_DIAGNOSTICS_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_TEXT_BUTTON system_diagnostics_windowchanger_main;
    GX_PROMPT system_diagnostics_battery_shortcut;
    GX_PROMPT system_diagnostics_ground_shortcut;
    GX_WINDOW system_diagnostics_window_battery_shortcut;
    GX_PROMPT system_diagnostics_sys_diagnostics;
    GX_WINDOW system_diagnostics_window_ground_shortcut;
    GX_WINDOW system_diagnostics_aptiv_signature;
} SYSTEM_DIAGNOSTICS_CONTROL_BLOCK;
...
extern SYSTEM_DIAGNOSTICS_CONTROL_BLOCK system_diagnostics;
#endif
